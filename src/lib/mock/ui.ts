/**
 * Mock data for UI components (categories, stats, pricing, etc.)
 */
...
export const TRENDING_FILTER_TABS = ['All', 'Photos', 'Vectors', 'Illustrations', 'Footage']

// Trending images for homepage
...
// Pricing features for homepage pricing section (simple arrays)
export const HOMEPAGE_PRICING_FEATURES = {
  starter: [
...
// Search media tabs
export const SEARCH_MEDIA_TABS = ['Photos', 'Videos', 'Footage', 'Vectors', 'Illustrations', 'Music', 'Templates', '3D']
